...
const LandingPage = () => {
  ...
  return (
    <div className={clsx(styles.container)}>
      ...
      <div data-aos="zoom-in-down" data-aos-duration="1500" className={styles.wrapWhy}>
        <div className={styles.floatIconLeft}>
          <Image priority={true} width={126} height={212} src="/images/float-icon.png" alt="" />
        </div>
        <div className={styles.background}>
          <Image alt="background" width={1960} height={846} objectFit="cover" src="/images/background-why.png"></Image>
        </div>
        <div className={styles.spacing}>
      ...
      <div data-aos="fade-up" data-aos-duration="1500"   className={styles.gallery}>
      ...
      <div  data-aos="zoom-in-up"  data-aos-duration="800" className={styles.spacing}>
        <OurProject />
      </div>
      ...
      <div className={styles.spacing}>
        <div  className={styles.ourTeam}>
          ...
          <Row gutter={[16, 0]} className={styles.listCard}>
            <Col  data-aos="fade-left" data-aos-duration="900"   className={styles.card} xs={24} sm={12} md={12} lg={6}>
            ...
            <Col  data-aos="fade-left" data-aos-duration="1300"   className={styles.card} xs={24} sm={12} md={12} lg={6}>
              <div className={styles.wrapCard}>
                <div className={styles.header}>
            ...
            <Col   data-aos="fade-left" data-aos-duration="1700"  className={styles.card} xs={24} sm={12} md={12} lg={6}>
              <div className={styles.wrapCard}>
                <div className={styles.header}>
            ...
            <Col  data-aos="fade-left" data-aos-duration="2100"   className={styles.card} xs={24} sm={12} md={12} lg={6}>
              <div className={styles.wrapCard}>
                <div className={styles.header}>
      ...
      <div className={styles.spacing}>
        <div className={styles.clientSay}>
          <div  data-aos="fade-right" data-aos-duration="1500"  className={styles.clientTitle}>{t('clientSays.title')}</div>
