          ...
          <Row>
            ...
            <Col className={styles.right} sm={24} md={12}>
              ...
              <div className={styles.text}>
                ...
                reasonable prices, has been actively integrating into the global economy through a broad system of FTAs.
              </div>
              <div className={styles.text}>
                In the current advantageous macro-environment, IDS's goal is to assist international purchasing units in
                clarifying and systematizing purchase plans in order to achieve optimal efficiency.
              </div>
            </Col>
          </Row>
        </div>
        ...
        <div className={styles.spacing}>
          <Row gutter={[93, 0]}>
            <Col md={14}>
              ...
              <div className={styles.text}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ipsum sit faucibus arcu sit.
              </div>
              <Row gutter={[15, 20]}>
